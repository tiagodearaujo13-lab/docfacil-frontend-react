        ...
        <div className={styles.stepsSection}>
            ...
            <div className={styles.listaDePassos}>
                ...
                <div className={styles.passo}>
                    ...
                    <p>Pode ser um Contrato de Prestação de Serviço, Contrato de Arrendamento, Documento Único Automóvel (DUA) entre outros.</p>
                </div>

                <div className={styles.passo}>
                    <div className={styles.circuloNumero}>2</div>
                    <h3>Preencha os Dados</h3>
                    <p>Insira as informações, os detalhes do serviço e os valores no nosso formulário guiado.</p>
                </div>

                <div className={styles.passo}>
                    <div className={styles.circuloNumero}>3</div>
                    <h3>Descarregue o PDF</h3>
                    <p>Receba instantaneamente um PDF de alta qualidade, pronto para enviar ao seu cliente.</p>
                </div>
