  ...
  return (
    <div className={styles.heroSection} style={estiloDoHero}>
      ...
      <p className={styles.subtitulo}>
        O DocFacil.pt é a sua arma secreta contra a papelada. Crie propostas e
        contratos profissionais, juridicamente informados para Portugal, em
        menos tempo do que leva a tomar um café.
      </p>
